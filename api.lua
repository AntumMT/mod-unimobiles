...
--- Mob drops.
--
-- @table mobs:def.drops
-- @tfield string name Item name (e.g. "default:stone").
-- @tfield int chance The inverted chance (same as in abm) to get the item.
-- @tfield int min Minimum number of items dropped at one time.
-- @tfield int max Maximum number of items dropped at one time.
--
-- **Example:**
-- <pre>
-- drops = {
